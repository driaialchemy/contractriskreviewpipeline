...
from src.config import CUAD_JSON_NAME, get_dataset_zip_path
...
class ExtractionAgent(BaseAgent):
    """Extracts playbook clause spans from CUAD question-answer pairs."""
    ...
    async def process(self, state: AgentState) -> AgentState:
        ...
        try:
            ...
            contract = await asyncio.to_thread(
                _load_contract_from_zip, get_dataset_zip_path(), state.contract_title
            )
