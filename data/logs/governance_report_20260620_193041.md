...
**Generated:** 2026-06-20T19:30:41.004456+00:00
**Overall Status:** fail
**Risk Level:** critical
**Exit Code:** 1
...
- **repo**: FAIL (critical=1, warnings=0, info=2)
...
- **[critical] critical_sensitive_path_present** (validation_only) (`.env.example`): Critical sensitive path present: .env.example
  - Remediation: Remove or protect critical sensitive files; never commit secrets or production data
